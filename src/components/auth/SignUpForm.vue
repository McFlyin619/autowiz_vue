		...
		<form @submit.prevent="signUp">
			...
			<div v-show="isPro">
				...
				<div class="row row-cols-1 row-cols-md-5 container">
					...
					<label
						class="btn btn-pro me-1 mt-1"
						:class="{ 'btn-pro-checked': services.includes('Alarm/Security') }"
						for="1"
						>Alarm/Security</label
					>

					<input v-model="services" value="Auto Body" type="checkbox" class="btn-check" id="2" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Body') }"
						for="2"
						>Auto Body</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Detailing') }"
						for="3"
						>Auto Detailing</label
					>

					<input v-model="services" value="Auto Glass Tinting" type="checkbox" class="btn-check" id="4" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Glass Tinting') }"
						for="4"
						>Auto Glass Tinting</label
					>

					<input v-model="services" value="Auto Glass Repair" type="checkbox" class="btn-check" id="5" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Glass Repair') }"
						for="5"
						>Auto Glass Repair</label
					>

					<input v-model="services" value="Auto Parts" type="checkbox" class="btn-check" id="6" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Parts') }"
						for="6"
						>Auto Parts</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Repair') }"
						for="7"
						>Auto Repair</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Salvage Yards') }"
						for="8"
						>Auto Salvage Yards</label
					>

					<input v-model="services" value="Auto Wrap" type="checkbox" class="btn-check" id="10" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Auto Wrap') }"
						for="10"
						>Auto Wrap</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Brake Repair') }"
						for="11"
						>Brake Repair</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Car Wash') }"
						for="12"
						>Car Wash</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Oil Change') }"
						for="13"
						>Oil Change</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Smog/Emissions Testing') }"
						for="14"
						>Smog/Emissions Testing</label
					>

					<input v-model="services" value="Tires/Wheels" type="checkbox" class="btn-check" id="15" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Tires/Wheels') }"
						for="15"
						>Tires/Wheels</label
					>
					...
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Towing Services') }"
						for="16"
						>Towing Services</label
					>

					<input v-model="services" value="Transmission Repair" type="checkbox" class="btn-check" id="17" />
					<label
						class="btn me-1 btn-pro mt-1"
						:class="{ 'btn-pro-checked': services.includes('Transmission Repair') }"
						for="17"
						>Transmission Repair</label
					>
				</div>
				<hr />
			</div>
